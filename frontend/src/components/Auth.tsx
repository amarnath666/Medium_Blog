...
import { SignupInput } from "@amarnathdhumal/medium-common";
import { LablledInput } from "./LabelledInput";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LablledInput label="Name" placeholder="name.." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LablledInput label="email" placeholder="email.." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            email: e.target.value
                        })
                    }} />   
                    <LablledInput label="password" type={"password"} placeholder="password.." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
